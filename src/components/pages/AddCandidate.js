...
const {addCandidate}=useCandidatesData();
  ...
  e.preventDefault();
  addCandidate(nameRef.current.value,partyRef.current.value,ageRef.current.value,qualRef.current.value);
        ...
        <div className="mainBox">
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="inputAddBox">
            <div className="AddlabelInput">
              <label>Name:</label> <br />
              <input required type="text" placeholder="Name" ref={nameRef} name="name"></input>
            </div>
            <div className="AddlabelInput">
              <label>Party :</label> <br />
              <input type="text" placeholder="Party" ref={partyRef}  name="party"></input>
            </div>
            <div className="AddlabelInput">
              <label>Age :</label> <br />
              <input type="text" placeholder="Age" ref={ageRef} name="age"></input>
            </div>
            <div className="AddlabelInput">
